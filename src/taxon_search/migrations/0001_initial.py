    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='taxon_search.ncbitaxanode')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('taxaname_taxon_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='taxaname_taxon_id', to='taxon_search.ncbitaxanode')),
            ],
            options={
